...
export interface PhotoFrameProducerInput { image: PhotoBytes | string; style: AvatarStyleId; directions?: AvatarDirection[]; mimeType?: string }
...
export interface AvatarImageStorage {
  ...
  put(frameSetId: string, key: 'center' | AvatarDirection, image: GeneratedImage): Promise<StoredImage>;
  read(frameSetId: string, key: 'center' | AvatarDirection): Promise<GeneratedImage>;
}
